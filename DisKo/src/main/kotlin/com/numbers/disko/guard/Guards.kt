...
inline val ReactionAddEvent.isAuthor: Boolean
    get() {
        return user.longID == author.longID
    }

fun ReactionAddEvent.byUser(user: IUser): Boolean {
    return user.longID == this.user.longID
}
